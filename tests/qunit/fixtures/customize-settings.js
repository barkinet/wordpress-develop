...
window._wpCustomizeSettings = {
	...
	"url": {
		"activated": "http://src.wordpress-develop.dev/wp-admin/themes.php?activated=true&previewed",
		"ajax": "/wp-admin/admin-ajax.php",
		"allowed": [
			"http://src.wordpress-develop.dev/"
		],
		"fallback": "http://src.wordpress-develop.dev/?preview=1&template=twentyfifteen&stylesheet=twentyfifteen&preview_iframe=1&TB_iframe=true",
		"home": "http://src.wordpress-develop.dev/",
		"isCrossDomain": false,
		"login": "http://src.wordpress-develop.dev/wp-login.php?interim-login=1&customize-login=1",
		"parent": "http://src.wordpress-develop.dev/wp-admin/",
		"preview": "http://src.wordpress-develop.dev/"
	}
};
