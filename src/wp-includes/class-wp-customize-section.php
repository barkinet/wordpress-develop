...
class WP_Customize_Themes_Section extends WP_Customize_Section {
	...
	protected function render() {
		...
		<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="<?php echo esc_attr( $classes ); ?>">
			<h3 class="accordion-section-title" tabindex="0">
				<?php echo esc_html( $this->title ); ?>
				<span class="screen-reader-text"><?php esc_html_e( 'Press return or enter to expand' ); ?></span>
			</h3>
			...
			<div class="customize-themes-panel control-panel-content themes-php">
				...
				<?php if ( ! is_multisite() && current_user_can( 'install_themes' ) ) : ?>
					<a href="<?php echo esc_url( admin_url( 'theme-install.php' ) ); ?>" target="_top" class="add-new-h2"><?php echo esc_html_x( 'Add New', 'Add new theme' ); ?></a>
				<?php endif; ?>
				</h2>
				...
				<?php if ( 6 < count( $this->controls ) ) : ?>
					<p><label for="themes-filter">
						<span class="screen-reader-text"><?php esc_html_e( 'Search installed themes...' ); ?></span>
